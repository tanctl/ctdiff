...
//! Shows how timing side-channels can be exploited to learn information about file contents without direct access
    ...
    pub fn format_report(&self) -> String {
        ...
        for comparison in &self.timing_analysis {
            ...
            if comparison.significant_difference {
                report.push_str("  vulnerable: significant timing difference detected\n");
            } else {
        ...
        if self.attack_success_probability > 0.6 {
            ...
            report.push_str("\nmoderate risk: attack may succeed w more samples\n");
        } else {
...
impl AttackSimulator {
    ...
    /// create simulator w specific security configuration
    ...
    fn calculate_attack_success_probability(&self, timing_analysis: &[TimingComparison]) -> f64 {
        ...
        // - magnitude of timing differences
